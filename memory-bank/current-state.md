...
- Error page yok (bkz. backlog "Temel tarayici yuzeyleri"); downloads sayfasi var ama kayitlar oturum ici (kalici degil) ve ilerleme canli guncellenmiyor (sayfa "Yenile" ile tazelenir); kisayollar sabit (kullanici tarafindan ayarlanamaz).
- Grup ogesi/ozel kisayol URL'siz ise Google aramasina duser; arama motoru tercihi ayarlara baglanmali. Favicon'lar oturumlar arasi cache'lenmiyor (her sayfa yuklendiginde yeniden gelir).
